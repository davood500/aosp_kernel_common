...
void f2655_night_select(struct i2c_client *client,int enable)
{
}
/*--------------------------------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------------------------------*/
...
void f2655_set_wb_auto_mode(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3306,0x00);   // select Auto WB
}

void f2655_set_wb_sunny_mode(struct i2c_client *client)
{
...
void f2655_set_wb_cloudy_mode(struct i2c_client *client)
{ 
...
void f2655_set_wb_office_mode(struct i2c_client *client)
{ 
	sensor_write_reg16(client,0x3306, 0x02);  // Disable Auto WB, select Manual WB
...
void f2655_set_wb_home_mode(struct i2c_client *client)
{
...
void f2655_ab_auto(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3014, 0x4c);    /* enable banding and 50 Hz */
}

void f2655_ab_50hz(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3014, 0x8c);    /* enable banding and 50 Hz */
}


void f2655_ab_60hz(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3014, 0x0c);    /* enable banding and 60 Hz */
}


void f2655_ab_off(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3014, 0x4c);    /* enable banding and 50 Hz */
}
/*--------------------------------------------------------------------------------------------------*/
...
void f2655_set_effect_normal(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3391, 0x00);
}

void f2655_set_effect_sepia(struct i2c_client *client)
{
...
void f2655_set_effect_bluish(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3391, 0x18);
...
void f2655_set_effect_greenish(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3391, 0x18);
...
void f2655_set_effect_reddish(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3391, 0x18);
...
void f2655_set_effect_yellowish(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3391, 0x18);
...
void f2655_set_effect_blackwhite(struct i2c_client *client)
{
	sensor_write_reg16(client,0x3391, 0x20);
}

void f2655_set_effect_negative(struct i2c_client *client)
{
