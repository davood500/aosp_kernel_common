  ...
  //	dprintk("ov2655_set_balance");
	switch(balance_flag)
	{
		...
		case WHITE_BALANCE_TUNGSTEN :
			ov2655_set_wb_home_mode(ov2655.client);
			dprintk("wb_tungsten ");
			break;
	}
	return 0;
...
int ov2655_sensor_probe(void)
{
	...
	sensor_id = sensor_read_reg16(ov2655.client,0x300a);
	printk("-----------------------------ov2655 0x300a read is %d\n",sensor_id);
...
int ov2655_set_function(int function)
{
	...
	{
		case 0:
			ov2655_preview_set(ov2655.client);
			break;
		case 1:
			ov2655_capture_set(ov2655.client);
			break;
		case 2:		
			break;
	}
...
{
	ov2655_size_switch(ov2655.client,width,height,mode);
	return 0;         
}
...
static int ov2655_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	ov2655.desc.facing = pdata->facing;
	ov2655.desc.orientation = pdata->orientation;
...
struct ov2655_sensor ov2655 = {
	.desc = {
		...
		.cfg_info = {
			...
			.format = SENSOR_OUTPUT_FORMAT_VY0UY1,
		},
