...
void gc2015_init_setting(struct i2c_client *client,int mirror)
{
	...
	sensor_write_reg(client,0xfe , 0x00);
	sensor_write_reg(client,0x45 , 0x00); //output_disable
	//////////////////////////////////////////////////////////////////////////////////////
	...
	if(mirror) 
		...
		sensor_write_reg(client,0x29 , 0x01); //cisctl mode 1
	...
	sensor_write_reg(client,0x37 , 0x03); //Drive Current 16  13  03
