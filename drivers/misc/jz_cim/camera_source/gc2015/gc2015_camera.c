...
{ 
	...
	mdelay(50);
	//sensor_write_reg(gc2015.client,0x37 , 0x3f); 
}
...
{
	//gc2015_reset();
	gc2015_init_setting(gc2015.client,pdata->mirror);
	return 0;
}
...
static int gc2015_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	gc2015.desc.facing = pdata->facing;
	gc2015.desc.orientation = pdata->orientation;
