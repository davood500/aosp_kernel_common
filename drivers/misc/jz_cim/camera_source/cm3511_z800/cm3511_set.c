...
{	
	...
	sensor_write_reg(client,0x11, 0x90);//rotate
	sensor_write_reg(client,0x12, 0x04);//Pclk inversion 4
	...
	sensor_write_reg(client,0x40, 0x02);
	sensor_write_reg(client,0x41, 0x4a);//0150
	...
	sensor_write_reg(client,0x40, 0x18);//brightness
	sensor_write_reg(client,0x41, 0x05);
	sensor_write_reg(client,0x50, 0x50);

	sensor_write_reg(client,0x60, 0x1f);
	sensor_write_reg(client,0x61, 0xb8);
	sensor_write_reg(client,0x62, 0xb0);
	...
	sensor_write_reg(client,0x13, 0x02);
	sensor_write_reg(client,0x20, 0x04);
	sensor_write_reg(client,0x21, 0x03);
	sensor_write_reg(client,0x23, 0x18);
	sensor_write_reg(client,0x24, 0x03);
	sensor_write_reg(client,0x29, 0xff);
	...
	sensor_write_reg(client,0x20, 0x00);
	sensor_write_reg(client,0x28, 0x07);//
	...
	sensor_write_reg(client,0x60, 0x00);
        sensor_write_reg(client,0x70, 0x42);// 42
	...
	sensor_write_reg(client,0xb2, 0x90);//AGMAX 80
	...
	sensor_write_reg(client,0xc3, 0x10);// 60
	sensor_write_reg(client,0xc4, 0x18);// 58
...
int cm3511_set_r(struct i2c_client *client,int width,int height)
{
	if(width == 352 && height == 288)
	{  
		sensor_write_reg(client,0x03, 0x12);
		sensor_write_reg(client,0x40, 0x22);
		sensor_write_reg(client,0x03, 0x13);
		sensor_write_reg(client,0x83, 0x5c);   
		sensor_write_reg(client,0x03, 0x18);   
      		sensor_write_reg(client,0x10, 0x05);
		sensor_write_reg(client,0x20, 0x01);
		sensor_write_reg(client,0x21, 0x60);
		...
		sensor_write_reg(client,0x29, 0x60);
		sensor_write_reg(client,0x2a, 0x01);
		sensor_write_reg(client,0x2b, 0x18);
		sensor_write_reg(client,0x2c, 0x0d);
		sensor_write_reg(client,0x2d, 0xb6);
		sensor_write_reg(client,0x2e, 0x0e);
		sensor_write_reg(client,0x2f, 0x8b);
		sensor_write_reg(client,0x30, 0x51);
