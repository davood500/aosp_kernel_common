...
//	dprintk("-----------------------------------------------cm3511_sensor_probe \n");
	...
	dprintk("---------------------------cm3511 sensor read is %d",sensor_id);
	cm3511_power_down();
	if(sensor_id == 0x81)
		return 0; 
...
{
	cm3511_set_r(cm3511.client,width,height);
	return 0;
}
...
static int cm3511_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	cm3511.desc.facing = pdata->facing;
	cm3511.desc.orientation = pdata->orientation;
