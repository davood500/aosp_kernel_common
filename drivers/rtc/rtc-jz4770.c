...
static int jz4770_rtc_probe(struct platform_device *pdev)
{
...
static int jz4770_rtc_remove(struct platform_device *pdev)
{
	struct rtc_device *rtc = platform_get_drvdata(pdev);
...
static int __init jz4770_rtc_init(void)
{
	return platform_driver_register(&jz4770_rtc_driver);
}

static void __exit jz4770_rtc_exit(void)
{
	platform_driver_unregister(&jz4770_rtc_driver);
}

module_init(jz4770_rtc_init);
module_exit(jz4770_rtc_exit);
