/*
 *  linux/drivers/net/jz47xx_eth.c
 *
 *  Jz47xx On-Chip ethernet driver.
 *
...
#define DRV_NAME	"jz47xx_eth"
#define DRV_VERSION	"0.1"
#define DRV_AUTHOR	"Jason Wang <xwang@ingenic.cn>"
#define DRV_DESC	"JzSOC 47xx On-chip Ethernet driver"
...
#ifdef CONFIG_DEFAULT_ETH_NAME
	strcpy(dev->name, CONFIG_DEFAULT_ETH_NAME);
#endif
