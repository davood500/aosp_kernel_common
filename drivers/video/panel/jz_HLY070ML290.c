/*
 * kernel/drivers/video/panel/jz_HLY070ML290.c -- Ingenic LCD panel device
 *
...
static void HLY070ML290_panel_display_init(void)
{
	//llh set stand by pin here
	lcd_soc->soc_ops->gpio_set_pin(lcd_board->board_pin->LCD_STBY_PIN);
}

static void HLY070ML290_panel_display_on(void)
{
	if(!lcd_board)
...
static void HLY070ML290_panel_display_off(void)
{
...
static int HLY070ML290_panel_probe(struct lcd_soc_info *soc , struct lcd_board_info *board)
{
...
static struct lcd_panel_ops_info HLY070ML290_panel_ops = {
	.panel_init		=	HLY070ML290_panel_display_init,
	.panel_display_on	=	HLY070ML290_panel_display_on,
	.panel_display_off	=	HLY070ML290_panel_display_off,
	.panel_probe		=	HLY070ML290_panel_probe,
};

static struct lcd_panel_attr_info HLY070ML290_panel_attr = {
	.bpp = 24,	/* */
	...
	.fclk = 55,	/* frame clk */
	.hsw = 48,	/* hsync width, in pclk */
	.vsw = 3,	/* vsync width, in line count */
	.elw = 40,//13,	/* end of line, in pclk */
	.blw = 40,//40,	/* begin of line, in pclk */
	.efw = 13,//40,	/* end of frame, in line count */
	.bfw = 29,//29,	/* begin of frame, in line count */
	.fg0_bpp = 32,
	.fg1_bpp = 32,
};

static struct lcd_panel_info HLY070ML290_lcd_panel = {
	.name = "HLY070ML290",
	.panel_probable = 0,	// not probable
	.panel_attr = &HLY070ML290_panel_attr,
	.panel_ops = &HLY070ML290_panel_ops,
};

static int __init HLY070ML290_init(void)
{
	// register the panel with lcd drivers
	lcd_register_panel(&HLY070ML290_lcd_panel);
	return 0;
}

module_init(HLY070ML290_init);
