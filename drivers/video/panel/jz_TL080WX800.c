...
static void TL080WX800_panel_display_init(void)
{
...
static void TL080WX800_panel_display_on(void)
{
	if(!lcd_board)
...
static void TL080WX800_panel_display_off(void)
{
//	lcd_board->board_ops->lcd_board_power_off();
//	lcd_soc->soc_ops->gpio_clear_pin(lcd_board->board_pin->LCD_POWERON);
}

static int TL080WX800_panel_probe(struct lcd_soc_info *soc , struct lcd_board_info *board)
{
...
static struct lcd_panel_ops_info TL080WX800_panel_ops = {
	.panel_init		=	TL080WX800_panel_display_init,
	.panel_display_on	=	TL080WX800_panel_display_on,
	.panel_display_off	=	TL080WX800_panel_display_off,
	.panel_probe		=	TL080WX800_panel_probe,
};

static struct lcd_panel_attr_info TL080WX800_panel_attr = {
	.bpp = 24,	/* */
	...
	.phys_width = 174,/* width of screen physical size, in mm */
	.phys_height = 104,/* height of screen physical size, in mm */
	.w = 1280,	/* Panel Width(in pixel) */
	.h = 768,	/* Panel Height(in line) */
	.fclk = 60,	/* frame clk */
	.hsw = 28,	/* hsync width, in pclk */
...
static struct lcd_panel_info TL080WX800_lcd_panel = {
	.name = "TL080WX800",
	.panel_probable = 0,	// not probable
	.panel_attr = &TL080WX800_panel_attr,
	.panel_ops = &TL080WX800_panel_ops,
};

static int __init TL080WX800_init(void)
{
	// register the panel with lcd drivers
	lcd_register_panel(&TL080WX800_lcd_panel);
	return 0;
}

module_init(TL080WX800_init);
