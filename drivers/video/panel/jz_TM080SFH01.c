/*
 * kernel/drivers/video/panel/jz_TM080SFH01.c -- Ingenic LCD panel device
 *
...
static void TM080SFH01_panel_display_init(void)
{
	//nothing to do
}

static void TM080SFH01_panel_display_on(void)
{
	if(!lcd_board)
...
static void TM080SFH01_panel_display_off(void)
{
...
static int TM080SFH01_panel_probe(struct lcd_soc_info *soc , struct lcd_board_info *board)
{
...
static struct lcd_panel_ops_info TM080SFH01_panel_ops = {
	.panel_init		=	TM080SFH01_panel_display_init,
	.panel_display_on	=	TM080SFH01_panel_display_on,
	.panel_display_off	=	TM080SFH01_panel_display_off,
	.panel_probe		=	TM080SFH01_panel_probe,
};

static struct lcd_panel_attr_info TM080SFH01_panel_attr = {
	.bpp = 24,	/* */
	...
	.elw = 88,	/* end of line, in pclk */
	.blw = 46,	/* begin of line, in pclk */
	.efw = 39,	/* end of frame, in line count */
	.bfw = 40,	/* begin of frame, in line count */
	.fg0_bpp = 32,
	.fg1_bpp = 32,
};
...
static struct lcd_panel_info TM080SFH01_lcd_panel = {
	.name = "TM080SFH01",
	.panel_probable = 0,	// not probable
	.panel_attr = &TM080SFH01_panel_attr,
	.panel_ops = &TM080SFH01_panel_ops,
};

static int __init TM080SFH01_init(void)
{
	// register the panel with lcd drivers
	lcd_register_panel(&TM080SFH01_lcd_panel);
	return 0;
}

module_init(TM080SFH01_init);
