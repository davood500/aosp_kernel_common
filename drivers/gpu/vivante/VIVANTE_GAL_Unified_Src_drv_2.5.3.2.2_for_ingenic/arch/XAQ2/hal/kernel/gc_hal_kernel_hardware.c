...
#define gcmkREAD_DEBUG_REGISTER(control, block, index, data) \
    gcmkONERROR( \
        gckOS_WriteRegister(Hardware->os, \
                            ...
                            ((((gctUINT32) (0)) & ~(((gctUINT32) (((gctUINT32) ((((1 ? GC_DEBUG_CONTROL##control_block) - (0 ? GC_DEBUG_CONTROL##control_block) + 1) == 32) ? ~0 : (~(~0 << ((1 ? GC_DEBUG_CONTROL##control_block) - (0 ? GC_DEBUG_CONTROL##control_block) + 1))))))) << (0 ? GC_DEBUG_CONTROL##control_block))) | (((gctUINT32) ((gctUINT32) (index) & ((gctUINT32) ((((1 ? GC_DEBUG_CONTROL##control_block) - (0 ? GC_DEBUG_CONTROL##control_block) + 1) == 32) ? ~0 : (~(~0 << ((1 ? GC_DEBUG_CONTROL##control_block) - (0 ? GC_DEBUG_CONTROL##control_block) + 1))))))) << (0 ? GC_DEBUG_CONTROL##control_block)))));\
    gcmkONERROR( \
        gckOS_ReadRegister(Hardware->os, \
...
#define gcmkRESET_DEBUG_REGISTER(control, block) \
    gcmkONERROR( \
        gckOS_WriteRegister(Hardware->os, \
                            GC_DEBUG_CONTROL##control##_Address, \
                            ((((gctUINT32) (0)) & ~(((gctUINT32) (((gctUINT32) ((((1 ? GC_DEBUG_CONTROL##control_block) - (0 ? GC_DEBUG_CONTROL##control_block) + 1) == 32) ? ~0 : (~(~0 << ((1 ? GC_DEBUG_CONTROL##control_block) - (0 ? GC_DEBUG_CONTROL##control_block) + 1))))))) << (0 ? GC_DEBUG_CONTROL##control_block))) | (((gctUINT32) ((gctUINT32) (15) & ((gctUINT32) ((((1 ? GC_DEBUG_CONTROL##control_block) - (0 ? GC_DEBUG_CONTROL##control_block) + 1) == 32) ? ~0 : (~(~0 << ((1 ? GC_DEBUG_CONTROL##control_block) - (0 ? GC_DEBUG_CONTROL##control_block) + 1))))))) << (0 ? GC_DEBUG_CONTROL##control_block)))));\
    gcmkONERROR( \
        gckOS_WriteRegister(Hardware->os, \
                            GC_DEBUG_CONTROL##control##_Address, \
                            ((((gctUINT32) (0)) & ~(((gctUINT32) (((gctUINT32) ((((1 ? GC_DEBUG_CONTROL##control_block) - (0 ? GC_DEBUG_CONTROL##control_block) + 1) == 32) ? ~0 : (~(~0 << ((1 ? GC_DEBUG_CONTROL##control_block) - (0 ? GC_DEBUG_CONTROL##control_block) + 1))))))) << (0 ? GC_DEBUG_CONTROL##control_block))) | (((gctUINT32) ((gctUINT32) (0) & ((gctUINT32) ((((1 ? GC_DEBUG_CONTROL##control_block) - (0 ? GC_DEBUG_CONTROL##control_block) + 1) == 32) ? ~0 : (~(~0 << ((1 ? GC_DEBUG_CONTROL##control_block) - (0 ? GC_DEBUG_CONTROL##control_block) + 1))))))) << (0 ? GC_DEBUG_CONTROL##control_block)))))
