...
{ \
	return(gcoOS_Allocate(MemPool->os, \
							gcmSIZEOF(Type), \
							(gctPOINTER *) Pointer)); \
} \
 \
...
{ \
	...
	gcmERR_RETURN(gcoOS_Allocate(MemPool->os, \
							gcmSIZEOF(Type), \
							(gctPOINTER *) Pointer)); \
	gcmVERIFY_OK(gcoOS_ZeroMemory(*Block, gcmSIZEOF(Type))); \
	return gcvSTATUS_OK; \
} \
 \
gcmINLINE gceSTATUS \
...
{ \
	return(gcoOS_Free(MemPool->os, Pointer)); \
}
...
{ \
	...
	gcmERR_RETURN(gcoOS_Allocate(MemPool->os, \
							Size, \
							(gctPOINTER *) Pointer)); \
	gcmVERIFY_OK(gcoOS_ZeroMemory(*Block, Size)); \
	return gcvSTATUS_OK; \
} \
 \
gcmINLINE gceSTATUS \
...
{ \
	...
	gcmERR_RETURN(gcoOS_Allocate(MemPool->os, \
							Count * gcmSIZEOF(Type), \
							(gctPOINTER *) Pointer)); \
	gcmVERIFY_OK(gcoOS_ZeroMemory(*Pointer, Count * gcmSIZEOF(Type))); \
	return gcvSTATUS_OK; \
} \
 \
gcmINLINE gceSTATUS \
