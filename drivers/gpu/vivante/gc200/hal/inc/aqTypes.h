...
#	define gcmOFFSETOF(s, field) \
	( \
		(gctUINT32) & (((struct s *) 0)->field) \
	)
#else
#	define gcmOFFSETOF(s, field) \
	( \
		(gctUINT32) (gctUINT64) & (((struct s *) 0)->field) \
	)
#endif
...
**	Version Macros.
**
**	Version value gets read from the hardware register and has the following
**	format:
**
**		[31:24]		Major revision.
**		[23:16]		Minor revision.
**		[15:0]		Maintenance revision.
*/

#define gcmVERMAJOR(v) \
	(((v) >> 24) & 0xFF)

#define gcmVERMINOR(v) \
	(((v) >> 16) & 0xFF)

#define gcmVERMAINTENANCE(v) \
	((v) & 0xFFFF)
