...
*****************************************************************************
*  
*    Auto-generated file on 11/23/2011. Do not edit!!!
*  
*****************************************************************************/
    ...
    )
{
    ...
    do
    {
        ...
        if (pool == gcvPOOL_SYSTEM)
        {
            ...
            //pool = gcvPOOL_CONTIGUOUS; // not use __get_free_page when system running, it may cause kernel hanging.
            pool = gcvPOOL_VIRTUAL;      // Wolfgang@ingenic.cn, modify, 2011-02-18
        }
        else
