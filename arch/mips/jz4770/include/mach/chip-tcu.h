...
#ifndef __CHIP_TCU_H__
#define __CHIP_TCU_H__
...
#define __tcu_enable_bypass(n)	(REG_TCU_TCSR((n)) |= TCSR_BYPASS)
#define __tcu_disable_bypass(n)	(REG_TCU_TCSR((n)) &= ~TCSR_BYPASS)

#endif /* __MIPS_ASSEMBLER */


#endif /* __CHIP_TCU_H__ */
