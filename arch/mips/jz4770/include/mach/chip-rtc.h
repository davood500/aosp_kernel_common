...
#define RTC_CKPCR_OFFSET	(0x40)  /* rw, 32, 0x00000010 */
#define RTC_PMCR_OFFSET		(0x44)  /* rw, 32, 0x00000000 */
...
#define RTC_CKPCR	(RTC_BASE + RTC_CKPCR_OFFSET)	
#define RTC_PMCR	(RTC_BASE + RTC_PMCR_OFFSET)	
...
#define rtc_enable_clk32k() rtc_write_reg(RTC_CKPCR,ENABLE_CLK32K);
#define rtc_disable_clk32k() rtc_write_reg(RTC_CKPCR,DISABLE_CLK32K);
