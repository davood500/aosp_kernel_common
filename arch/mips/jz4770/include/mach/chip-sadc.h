...
#ifndef __CHIP_SADC_H__
#define __CHIP_SADC_H__
...
#define SADC_ADCMD_OFFSET       (0x24)  /* rw, 16, 0x0000 */
...
#define SADC_ADCMD		(SADC_BASE + SADC_ADFLT_OFFSET)  /* ADC Filter Register */
...
#define ADCFG_WRITE_SEL         BIT23
#define ADCFG_CMD_SEL           BIT22
//#define ADCFG_VBAT_SEL		BIT30
#define ADCFG_DMA_EN		BIT15

#define ADCFG_RPU_LSB           16    /* internal pull-up resistor for pen detction */
#define ADCFG_RPU_MASK          BITS_H2L(21,ADCFG_RPU_LSB)
...
#define REG_SADC_ADCMD          REG16(SADC_ADCMD)
...
typedef volatile struct
{
        ...
        unsigned short  ADCMD;
        unsigned short  ADCMDRSV[1];
        unsigned int    ADCLK;
} JZ4760_SADC, *PJZ4760_SADC;

#endif /* __MIPS_ASSEMBLER */

#endif /* __CHIP_SADC_H__ */
