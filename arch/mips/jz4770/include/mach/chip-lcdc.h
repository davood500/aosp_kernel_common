/*
 * arch/mips/mach-jz4760/include/mach/chip-lcdc.h
 *
...
#ifndef __CHIP_LCDC_H__
#define __CHIP_LCDC_H__
...
#define LCD_BGC_RED_OFFSET	16  /* Red color offset */
#define LCD_BGC_RED_MASK	(0xFF<<LCD_BGC_RED_OFFSET)
#define LCD_BGC_GREEN_OFFSET    8   /* Green color offset */
#define LCD_BGC_GREEN_MASK	(0xFF<<LCD_BGC_GREEN_OFFSET)
#define LCD_BGC_BLUE_OFFSET	0   /* Blue color offset */
...
#define LCD_PCFG_PCFG2_BIT	18
#define LCD_PCFG_PCFG2_MASK	(0x1ff << LCD_PCFG_PCFG2_BIT)
#define LCD_PCFG_PCFG1_BIT	9
#define LCD_PCFG_PCFG1_MASK	(0x1ff << LCD_PCFG_PCFG1_BIT)
#define LCD_PCFG_PCFG0_BIT	0
#define LCD_PCFG_PCFG0_MASK	(0x1ff << LCD_PCFG_PCFG0_BIT)
