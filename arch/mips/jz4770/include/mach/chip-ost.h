...
#ifndef __CHIP_OST_H__
#define __CHIP_OST_H__
...
#define OST_OSTCNTHBUF_OFFSET	(0xfc)  /* rw, 32, 0x???????? */
...
#define OST_OSTCNTHBUF (OST_BASE + OST_OSTCNTH_OFFSET)
