...
#ifndef __CHIP_I2C_H__
#define __CHIP_I2C_H__
 ...
 * I2C
 *************************************************************************/
#define	I2C_CTRL(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000+ 0x00)
#define	I2C_TAR(n)     		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x04)
#define	I2C_SAR(n)     		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x08)
#define	I2C_DC(n)      		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x10)
#define	I2C_SHCNT(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x14)
#define	I2C_SLCNT(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x18)
#define	I2C_FHCNT(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x1C)
#define	I2C_FLCNT(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x20)
#define	I2C_INTST(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x2C)
#define	I2C_INTM(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x30)
#define I2C_RXTL(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x38)
#define I2C_TXTL(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x3c)
#define	I2C_CINTR(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x40)
#define	I2C_CRXUF(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x44)
#define	I2C_CRXOF(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x48)
#define	I2C_CTXOF(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x4C)
#define	I2C_CRXREQ(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x50)
#define	I2C_CTXABRT(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x54)
#define	I2C_CRXDONE(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x58)
#define	I2C_CACT(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x5C)
#define	I2C_CSTP(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x60)
#define	I2C_CSTT(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x64)
#define	I2C_CGC(n)    		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x68)
#define	I2C_ENB(n)     		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x6C)
#define	I2C_STA(n)     		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x70)
#define	I2C_TXABRT(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x80)
#define I2C_DMACR(n)            (I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x88)
#define I2C_DMATDLR(n)          (I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x8c)
#define I2C_DMARDLR(n)          (I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x90)
#define	I2C_SDASU(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x94)
#define	I2C_ACKGC(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x98)
#define	I2C_ENSTA(n)		(I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0x9C)
#define I2C_SDAHD(n)            (I2C0_BASE + (n)*0x1000 + (n/2)*0x3000 + 0xD0)
...
#define __i2c_clear_interrupts(n)    ( REG_I2C_CINTR(n) )
...
#define __i2c_set_restart(n)          CLRREG16(I2C_CTRL(n), I2C_CTRL_REST)
#define __i2c_clr_restart(n)          SETREG16(I2C_CTRL(n), I2C_CTRL_REST)
