/*
 * arch/mips/mach-jz4760/include/mach/chip-ssi.h
 *
...
#ifndef __CHIP_SSI_H__
#define __CHIP_SSI_H__
...
/*
 * copied from: arch/arm/mach-imx/include/mach/spi_imx.h
*/
...
*/
struct jz47xx_spi_master {
        unsigned char	num_chipselect;
	int		*chipselect;
        unsigned char	enable_dma:1;
};
 ...
 * @clk_wait : number of bclk waits between each bits_per_word SPI burst.
...
*/
struct jz47xx_spi_chip {
	unsigned char	enable_loopback:1;
	unsigned char	enable_dma:1;
	unsigned char	ins_ss_pulse:1;
	unsigned short	clk_wait:15;
	unsigned char	bits_per_word:5;
	//void (*cs_control)(u32 control);
};

#endif /* __CHIP_SSI_H__ */
