/*
 * arch/mips/mach-jz4760/include/mach/chip-cim.h
 *
...
#ifndef __CHIP_CIM_H__
#define __CHIP_CIM_H__
...
#define CIM_CTRL_H_SYNC         (1 << 5) /*Enable horizental sync when CIMCFG.SEP is 1*/       
