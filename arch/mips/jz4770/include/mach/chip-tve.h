/*
 * arch/mips/mach-jz4760/include/mach/chip-tve.h
 *
...
#ifndef __CHIP_TVE_H__
#define __CHIP_TVE_H__
...
#define TVE_CTRL_CHSEL	        (1 << 21)    /* DAC 1 power down */	
