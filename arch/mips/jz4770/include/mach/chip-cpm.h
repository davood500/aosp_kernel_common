...
#ifndef __CHIP_CPM_H__
#define __CHIP_CPM_H__
...
#define CPM_USBPCR1_OFFSET      (0x48)  /* rw, 32, 0x00000000 */  
...
#define CPM_CPMINTR_OFFSET      (0xb0)  /* rw, 32, 0x00000000 */   
#define CPM_CPMINTRE_OFFSET     (0xb4)  /* rw, 32, 0x00000000 */
/*
...
#define CPM_CPMINTR      (CPM_BASE + CPM_CPMINTR_OFFSET) 
#define CPM_CPMINTRE     (CPM_BASE + CPM_CPMINTRE_OFFSET)
...
#define CPPCR0_BS               BIT31   /* set low or high band */
...
#define OPCR_IDLE_EN            BIT31   /* READ ONLY*/
#define OPCR_OTGPHY_ENABLE      BIT7    /* SPENDN bit */ /* Read Only*/
...
#define CPPCR1_PLL1N_MASK       BITS_H2L(22, CPPCR1_PLL1N_LSB)

#define CPPCR1_PLL1OD_LSB       16
#define CPPCR1_PLL1OD_MASK      BITS_H2L(17, CPPCR1_PLL1OD_LSB)

#define CPPCR1_P1SDIV_LSB       8
#define CPPCR1_P1SDIV_MASK      BITS_H2L(12, CPPCR1_P1SDIV_LSB)
...
#define MSCCDR_MCSG             BIT31   /* 1:STOP 0:RUN */
#define MSCCDR_MPCS             BIT30   /* 1:pll 1 0 :pll 0*/
...
#define UHCCDR_UHCDIV_MASK      BITS_H2L(5, UHCCDR_UHCDIV_LSB)

/* SSI clock divider register(SSICDR) */
#define SSICDR_SCS              BIT31
#define SSICDR_SPCS             BIT30   /* 1:PLL1 */
#define SSICDR_SSIDIV_LSB       0       /* SSICDR bit */
#define SSICDR_SSIDIV_MASK      BITS_H2L(6, SSICDR_SSIDIV_LSB)

/* CIM mclk clock divider register(CIMCDR) */
#define CIMCDR_CIMPCS           BIT31   /* 1:PLL1 */
...
#define GPUCDR_GPUDIV_MASK      BITS_H2L(4, GPUCDR_GPUDIV_LSB)
...
#define CPM_BCHCDR_BPCS		BIT31
#define CPM_BCHCDR_BCHM		BIT30
...
#define REG_CPM_CPMINTR         REG32(CPM_CPMINTR) 
#define REG_CPM_CPMINTRE        REG32(CPM_CPMINTRE)
...
#define CPM_POWER_AHB1 0

#define CPM_POWER_ON    1
#define CPM_POWER_OFF   0

void cpm_setup(void);
void cpm_power_ctrl(unsigned int devid,int poweron);

#endif /* __MIPS_ASSEMBLER */

#endif /* __CHIP_CPM_H__ */
