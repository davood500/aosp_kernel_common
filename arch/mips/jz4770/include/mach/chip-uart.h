/*
 * arch/mips/mach-jz4760/include/mach/chip-uart.h
 *
...
#ifndef __CHIP_UART_H__
#define __CHIP_UART_H__
...
do {	                    			\
	REG_GPIO_PXINTC(0) = 0x80000000;	\
	REG_GPIO_PXMSKC(0) = 0x80000000;	\
	REG_GPIO_PXPAT1C(0) = 0x80000000;	\
	REG_GPIO_PXPAT0S(0) = 0x80000000;	\
} while(0)
