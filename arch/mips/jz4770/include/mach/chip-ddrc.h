/*
 * arch/mips/mach-jz4760/include/mach/chip-ddrc.h
 *
...
#ifndef __CHIP_DDRC_H__
#define __CHIP_DDRC_H__
...
#define DDRC_PMEMBS0_OTDTQS3_BIT		30
#define DDRC_PMEMBS0_OTDTQS3_MASK		(0x03 << DDRC_PMEMBS0_OTDTQS3_BIT)

#define DDRC_PMEMBS0_OTDTQS2_BIT		28
#define DDRC_PMEMBS0_OTDTQS2_MASK               (0x03 << DDRC_PMEMBS0_OTDTQS2_BIT)

#define DDRC_PMEMBS0_OTDTQS1_BIT		26
#define DDRC_PMEMBS0_OTDTQS1_MASK               (0x03 << DDRC_PMEMBS0_OTDTQS1_BIT)  

#define DDRC_PMEMBS0_OTDTQS0_BIT		24
#define DDRC_PMEMBS0_OTDTQS0_MASK               (0x03 << DDRC_PMEMBS0_OTDTQS0_BIT)

#define DDRC_PMEMBS0_OTDTQ3_BIT			22
#define DDRC_PMEMBS0_OTDTQ3_MASK		(0x03 << DDRC_PMEMBS0_OTDTQ3_BIT)

#define DDRC_PMEMBS0_OTDTQ2_BIT			20
#define DDRC_PMEMBS0_OTDTQ2_MASK		(0x03 << DDRC_PMEMBS0_OTDTQ2_BIT)

#define DDRC_PMEMBS0_OTDTQ1_BIT			18
#define DDRC_PMEMBS0_OTDTQ1_MASK		(0x03 << DDRC_PMEMBS0_OTDTQ1_BIT)

#define DDRC_PMEMBS0_OTDTQ0_BIT			16
#define DDRC_PMEMBS0_OTDTQ0_MASK		(0x03 << DDRC_PMEMBS0_OTDTQ0_BIT)

#define DDRC_PMEMBS0_SSELDQS3_BIT		14
#define DDRC_PMEMBS0_SSELDQS3_MASK 	        (0x03 << DDRC_PMEMBS0_SSELDQS3_BIT)

#define DDRC_PMEMBS0_SSELDQS2_BIT		12
#define DDRC_PMEMBS0_SSELDQS2_MASK 	        (0x03 << DDRC_PMEMBS0_SSELDQS2_BIT)

#define DDRC_PMEMBS0_SSELDQS1_BIT		10
#define DDRC_PMEMBS0_SSELDQS1_MASK 	        (0x03 << DDRC_PMEMBS0_SSELDQS1_BIT)

#define DDRC_PMEMBS0_SSELDQS0_BIT		8
#define DDRC_PMEMBS0_SSELDQS0_MASK 	        (0x03 << DDRC_PMEMBS0_SSELDQS0_BIT)

#define DDRC_PMEMBS0_SSELDQ3_BIT		6
#define DDRC_PMEMBS0_SSELDQ3_MASK		(0x03 << DDRC_PMEMBS0_SSELDQ3_BIT)

#define DDRC_PMEMBS0_SSELDQ2_BIT		4
#define DDRC_PMEMBS0_SSELDQ2_MASK		(0x03 << DDRC_PMEMBS0_SSELDQ2_BIT)

#define DDRC_PMEMBS0_SSELDQ1_BIT		2
#define DDRC_PMEMBS0_SSELDQ1_MASK		(0x03 << DDRC_PMEMBS0_SSELDQ1_BIT)

#define DDRC_PMEMBS0_SSELDQ0_BIT		0
#define DDRC_PMEMBS0_SSELDQ0_MASK		(0x03 << DDRC_PMEMBS0_SSELDQ0_BIT)
/* DDRC IO pad control Register */
#define DDRC_PMEMBS1_ODTCK_BIT			18
#define DDRC_PMEMBS1_ODTCK_MASK			(0x03 << DDRC_PMEMBS1_ODTCK_BIT)

#define DDRC_PMEMBS1_ODTCKE_BIT			16
#define DDRC_PMEMBS1_ODTCKE_MASK		(0x03 << DDRC_PMEMBS1_ODTCKE_BIT)

#define DDRC_PMEMBS1_ODTADDR_BIT		14
#define DDRC_PMEMBS1_ODTADDR_MASK		(0x03 << DDRC_PMEMBS1_ODTADDR_BIT)

#define DDRC_PMEMBS1_ODTDM3_BIT			12
#define DDRC_PMEMBS1_ODTDM3_MASK		(0x03 << DDRC_PMEMBS1_ODTDM3_BIT)

#define DDRC_PMEMBS1_ODTDM2_BIT			10
#define DDRC_PMEMBS1_ODTDM2_MASK		(0x03 << DDRC_PMEMBS1_ODTDM2_BIT)

#define DDRC_PMEMBS1_ODTDM1_BIT			8
#define DDRC_PMEMBS1_ODTDM1_MASK		(0x03 << DDRC_PMEMBS1_ODTDM1_BIT)

#define DDRC_PMEMBS1_ODTDM0_BIT			6
#define DDRC_PMEMBS1_ODTDM0_MASK		(0x03 << DDRC_PMEMBS1_ODTDM0_BIT)

#define DDRC_PMEMBS1_ODTCMD_BIT			4
#define DDRC_PMEMBS1_ODTCMD_MASK		(0x03 << DDRC_PMEMBS1_ODTCMD_BIT)

#define DDRC_PMEMBS1_ODTCS1_BIT			2
#define DDRC_PMEMBS1_ODTCS1_MASK		(0x03 << DDRC_PMEMBS1_ODTCS1_BIT)

#define DDRC_PMEMBS1_ODTCS0_BIT			0
#define DDRC_PMEMBS1_ODTCS0_MASK		(0x03 << DDRC_PMEMBS1_ODTCS0_BIT)
...
/* DDRC IO pad control Register */
#define DDRC_PMEMOEN_PDDQS3			(1 << 31)
#define DDRC_PMEMOEN_PDDQS2			(1 << 30)
#define DDRC_PMEMOEN_PDDQS1			(1 << 29)
#define DDRC_PMEMOEN_PDDQS0			(1 << 28)
#define DDRC_PMEMOEN_PDDQ3			(1 << 27)
#define DDRC_PMEMOEN_PDDQ2			(1 << 26)
#define DDRC_PMEMOEN_PDDQ1			(1 << 25)
#define DDRC_PMEMOEN_PDDQ0			(1 << 24)
#define DDRC_PMEMOEN_SSTL2			(1 << 17)
#define DDRC_PMEMOEN_LVCMOS			(1 << 16)
#define DDRC_PMEMOEN_SINGLEDQS			(1 << 15)
