/*
 * arch/mips/mach-jz4760b/include/mach/chip-aosd.h
 *
 * JZ4760B ALPHA OSD & Compress register definition.
 *
 * Copyright (C) 2010 Ingenic Semiconductor Co., Ltd.
 */

#ifndef __CHIP_AOSD_H__
#define __CHIP_AOSD_H__
...
#define COMPRESS_CLK_GATE       (AOSD_BASE + 0x48)
#define COMPRESS_C_RESULT       (AOSD_BASE + 0x4C)
...
#define REG_COMPRESS_CLK_GATE        REG32(COMPRESS_CLK_GATE)
#define REG_COMPRESS_C_RESULT        REG32(COMPRESS_C_RESULT) 
