...
int gpio_sleep_state_table[][2] = {
	...
	{32 * 0 + 20,	GSS_INPUT_NOPULL}, /* MSC0_DATA  */
	{32 * 0 + 21,	GSS_INPUT_NOPULL}, /* MSC0_DATA  */
	{32 * 0 + 22,	GSS_INPUT_NOPULL}, /* MSC0_DATA  */
	{32 * 0 + 23,	GSS_INPUT_NOPULL}, /* MSC0_DATA  */
	...
	{32 * 1 +  2,	GSS_INPUT_NOPULL}, /* SD1_CD_NI  */
	{32 * 1 +  3,	GSS_INPUT_PULL  }, /* NC         */
	{32 * 1 +  4,	GSS_INPUT_PULL  }, /* NC         */
	{32 * 1 +  5,	GSS_OUTPUT_LOW  }, /* USB_DETE   */
	...
	{32 * 1 + 22,	GSS_INPUT_NOPULL}, /* AVDEFUSE_EN*/
	{32 * 1 + 24,	GSS_OUTPUT_LOW  }, /* BT_RST_N   */ 
	{32 * 1 + 25,	GSS_OUTPUT_LOW  }, /* WL_RST_N   */
	{32 * 1 + 26,	GSS_INPUT_PULL  }, /* NC         */
	{32 * 1 + 27,	GSS_INPUT_PULL 	}, /* TSD7       */ 
	{32 * 1 + 28,	GSS_INPUT_PULL  }, /* TSCLK      */
	{32 * 1 + 29,	GSS_INPUT_PULL 	}, /* TSSTR      */
	{32 * 1 + 30,	GSS_INPUT_PULL  }, /* TS_IRQ_N   */
	{32 * 1 + 31,	GSS_INPUT_PULL 	}, /* TSFRM      */
	...
	{32 * 2 + 29,	GSS_INPUT_NOPULL}, /* FVDD_EN    */
	{32 * 2 + 30,	GSS_OUTPUT_LOW  }, /* UART2_TXD  */ 
	{32 * 2 + 31,	GSS_INPUT_PULL 	}, /* NC         */
	/* GPIO Group - D */
	{32 * 3 +  0,	GSS_OUTPUT_LOW  }, /* PCM_DO     */
    {32 * 3 +  1,	GSS_OUTPUT_LOW  }, /* PCM_CLK    */ 
	{32 * 3 +  2,	GSS_OUTPUT_LOW  }, /* PCM_SYN    */
	...
	{32 * 3 + 24,	GSS_OUTPUT_LOW  }, /* MSC1_CLK   */
	{32 * 3 + 25,	GSS_OUTPUT_LOW  }, /* MSC1_CMD   */
	{32 * 3 + 26,   GSS_OUTPUT_LOW  }, /* UART1_RXD  */
	{32 * 3 + 27,   GSS_OUTPUT_LOW  }, /* UART1_CTS  */
	{32 * 3 + 28,   GSS_OUTPUT_LOW  }, /* UART1_TXD  */
	{32 * 3 + 29,   GSS_OUTPUT_LOW  }, /* UART1_RTS  */
	...
	{32 * 4 +  2,	GSS_INPUT_NOPULL}, /* LCD_RESET  */ 
	{32 * 4 +  3,	GSS_INPUT_NOPULL}, /* CIM_RESET  */ 
	{32 * 4 +  4,	GSS_INPUT_NOPULL}, /* CIM_EN     */
	{32 * 4 +  5,	GSS_OUTPUT_LOW	}, /* I2S_MCLK   */ 
	{32 * 4 +  6,	GSS_INPUT_NOPULL}, /* HDMI_RST_N */ 
	{32 * 4 +  7,	GSS_OUTPUT_LOW	}, /* I2S_D0     */ 
	{32 * 4 +  8,	GSS_INPUT_PULL	}, /* NC         */  
	{32 * 4 +  9,	GSS_INPUT_NOPULL}, /* SD1_VCC_EN */ 
	...
	{32 * 4 + 13,	GSS_OUTPUT_LOW  }, /* LCD_VCC_EN */ 
#else
	...
	{32 * 4 + 19,	GSS_INPUT_NOPULL}, /* PMU_IRQ_N  */ 
	...
	{32 * 4 + 26,	GSS_INPUT_NOPULL}, /* POWER_IND_N*/  
	...
	{32 * 5 +  2,	GSS_INPUT_NOPULL}, /* CHARGE_DET_N*/ 
	{32 * 5 +  3,	GSS_INPUT_NOPULL}, /* HP_MUTE    */ 
	{32 * 5 +  4,	GSS_INPUT_NOPULL}, /* WL_BT_REG_ON*/ 
	{32 * 5 +  5,	GSS_INPUT_NOPULL}, /* DC_DETE    */ 
	{32 * 5 +  6,	GSS_OUTPUT_LOW  }, /* BT_INT     */ 
	{32 * 5 +  7,	GSS_OUTPUT_LOW  }, /* LS_GC2     */ 
	{32 * 5 +  8,	GSS_OUTPUT_LOW  }, /* BT_WAKE    */ 
	{32 * 5 +  9,	GSS_OUTPUT_LOW 	}, /* WL_INT     */ 
	{32 * 5 + 10,	GSS_OUTPUT_LOW  }, /* BT/WLAN_PW_EN*/ 
	{32 * 5 + 11,	GSS_OUTPUT_LOW  }, /* WL_WAKE    */ 
	{32 * 5 + 12,	GSS_INPUT_NOPULL}, /* HDMI_INT_N */ 
	{32 * 5 + 13,	GSS_INPUT_NOPULL}, /* SENSOR_INT1*/ 
	{32 * 5 + 14,	GSS_OUTPUT_LOW  }, /* LS_GC1     */ 
	{32 * 5 + 15,	GSS_OUTPUT_LOW  }, /* charge_current_set*/ 
	{32 * 5 + 16,	GSS_OUTPUT_LOW  }, /* LCD_L/R    */ 
	{32 * 5 + 17,	GSS_OUTPUT_LOW  }, /* LCD_U/D    */ 
	{32 * 5 + 18,	GSS_INPUT_NOPULL}, /* ID         */ 
	{32 * 5 + 19,	GSS_INPUT_PULL	}, /* NC         */  
	{32 * 5 + 20,	GSS_OUTPUT_LOW  }, /* AMPEN      */ 
	{32 * 5 + 21,	GSS_INPUT_NOPULL}, /* JD         */ 
