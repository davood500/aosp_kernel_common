...
#ifndef __ASM_JZ4770_NPM701_H__
#define __ASM_JZ4770_NPM701_H__
...
#ifdef CONFIG_NPM701_V_1_0
#define GPIO_OTG_ID_PIN         GPC28
/*======================================================================
 * HDMI
 */
 ...
 * HA2605
 */
#define GPIO_HA2605_INT		(32 * 2 + 29)	//GPC29
#define GPIO_HA2605_IRQ		(IRQ_GPIO_0 + GPIO_HA2605_INT)//* Used for GPIO-based bitbanging I2C

/*======================================================================
 * Camera Power Pin
 */
#define GPIO_CAM_PWR_ON	(32 * 5 + 7)	/*GPF7*/
/*======================================================================
 * I2C
 */
#define GPIO_I2C3_SDA	(32 * 0 + 6)	/* GPA6 */
#define GPIO_I2C3_SCK	(32 * 0 + 3)	/* GPA3 */

#define GPIO_I2C4_SDA	(32 * 3 + 5)	/* GPD5 */
#define GPIO_I2C4_SCK	(32 * 3 + 4)	/* GPD4 */

#define GPIO_I2C5_SDA	(32 * 3 + 7)	/* GPD7 */
#define GPIO_I2C5_SCK	(32 * 3 + 6)	/* GPD6 */

#define GPIO_I2C6_SDA	GPE30	
#define GPIO_I2C6_SCK	GPE31	
/*======================================================================
 * MMC/SD
 */
#define GPIO_SD2_VCC_EN_N	INVALID_PIN
...
/* configure i2s gpio fuction for hdmi(external audio codec).
 * if used hdmi(it6610), then defined CONFIG_JZ_EXTERNAL_CODEC_I2S_SELECT in menuconfig;
 * and ensure the i2s gpio config is correct.   
 */
#define CONFIG_JZ_EXTERNAL_CODEC_I2S_CONFIGURE

#ifdef  CONFIG_JZ_EXTERNAL_CODEC_I2S_CONFIGURE
#define __gpio_as_ex_i2s()		\
do {					\
	REG_GPIO_PXINTC(3) =  0x00002000;	\
	REG_GPIO_PXMSKC(3) =  0x00002000;	\
	REG_GPIO_PXPAT1C(3) = 0x00002000;	\
	REG_GPIO_PXPAT0C(3) = 0x00002000;	\
	REG_GPIO_PXINTC(3) =  0x00001000;	\
	REG_GPIO_PXMSKC(3) =  0x00001000;	\
	REG_GPIO_PXPAT1C(3) = 0x00001000;	\
	REG_GPIO_PXPAT0S(3) = 0x00001000;	\
	REG_GPIO_PXINTC(4) =  0x00000080;	\
	REG_GPIO_PXMSKC(4) =  0x00000080;	\
	REG_GPIO_PXPAT1C(4) = 0x00000080;	\
	REG_GPIO_PXPAT0C(4) = 0x00000080;	\
} while (0)
#endif
