...
#ifndef __ASM_JZ4770_O1_H__
#define __ASM_JZ4770_O1_H__
...
#define GPIO_FT5X0X_INT		(32 * 1 + 19)	//GPB19
#define GPIO_FT5X0X_WAKE	(32 * 1 + 18)	//GPB18
#define GPIO_FT5X0X_IRQ		(IRQ_GPIO_0 + GPIO_FT5X0X_INT)//* Used for GPIO-based bitbanging I2C 
...
#define GPIO_LCD_VCC_EN         GPF00  //(32 * 5 + 0)
...
#define GPIO_SD1_CD_N		(32 * 1 + 2) /* GPB02 */
...
#define ACTIVE_LEVEL_HEAD_DET   0 
