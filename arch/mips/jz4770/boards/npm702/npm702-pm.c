/*
 * linux/arch/mips/jz4760/board-npm702.c
 *
...
int gpio_sleep_state_table[][2] = {
	...
	{32 * 0 +  1,	GSS_INPUT_NOPULL}, /* ACC_INT2 input pull*/
	...
	{32 * 0 +  9,	GSS_IGNORE  }, /* ACC_INT1 input pull*/
	...
	{32 * 0 + 18,	GSS_OUTPUT_LOW}, /* NF_RE/MSC0_CLK */
	{32 * 0 + 19,	GSS_INPUT_NOPULL}, /* NF_WE/MSC0_CMD */
	{32 * 0 + 20,	GSS_INPUT_NOPULL}, /* NF_RB/MSC0_D0 */
	{32 * 0 + 21,	GSS_INPUT_NOPULL}, /* NF_CS1/MSC0_D1 */
	{32 * 0 + 22,	GSS_INPUT_NOPULL}, /* NF_CS2/MSC0_D2 */
	{32 * 0 + 23,	GSS_INPUT_NOPULL}, /* NF_CS3/MSC0_D3 */
	{32 * 0 + 24,	GSS_INPUT_PULL	}, /* NC */
	{32 * 0 + 25,	GSS_INPUT_PULL	}, /* NC */
	{32 * 0 + 26,	GSS_INPUT_PULL  }, /* NC */
	{32 * 0 + 27,	GSS_INPUT_NOPULL}, /* WAIT_N */
	...
	{32 * 1 +  5,	GSS_INPUT_NOPULL}, /* USB_DETE */
	...
	{32 * 1 + 19,	GSS_OUTPUT_LOW}, /* TP_SHUTDOWN */ 
	{32 * 1 + 20,	GSS_INPUT_NOPULL}, /* MSC2_D0 */ 
	{32 * 1 + 21,	GSS_INPUT_NOPULL}, /* MSC2_D1 */ 
	{32 * 1 + 22,	GSS_INPUT_NOPULL}, /* AVDEFUSE_EN_N ??*/ 
	{32 * 1 + 23,	GSS_INPUT_PULL	}, /* NC */ 
	{32 * 1 + 24,	GSS_INPUT_NOPULL}, /* SD1_CD_N */
	{32 * 1 + 25,	GSS_INPUT_PULL	}, /* NC */ 
	{32 * 1 + 26,	GSS_INPUT_PULL	}, /* NC */ 
	{32 * 1 + 27,	GSS_INPUT_NOPULL}, /*GSS_OUTPUT_LOW	},*/ /* TP_INT ??*/ 
{32 * 1 + 28,	GSS_OUTPUT_LOW	}, /* MSC2_CLK */ 
{32 * 1 + 29,	GSS_INPUT_NOPULL}, /* MSC2_CMD */ 
{32 * 1 + 30,	GSS_INPUT_NOPULL}, /* MSC2_D2 */ 
{32 * 1 + 31,	GSS_INPUT_NOPULL}, /* MSC2_D3 */ 
...
{32 * 2 + 28,	GSS_INPUT_NOPULL	}, /* UART2_RXD */
{32 * 2 + 29,	GSS_IGNORE	}, /* PC29/SD_VCC_EN */ 
{32 * 2 + 30,	GSS_OUTPUT_LOW	}, /* UART_TXD */ 
{32 * 2 + 31,	GSS_INPUT_NOPULL	}, /* UART_RTS */ 
	/* GPIO Group - D */
{32 * 3 +  0,	GSS_OUTPUT_LOW  }, /* WL_PCM_DO */ 
{32 * 3 +  1,	GSS_OUTPUT_LOW	    }, /* WL_PCM_CLK */ 
{32 * 3 +  2,	GSS_OUTPUT_LOW	    }, /* WL_PCM_SYN */ 
{32 * 3 +  3,	GSS_OUTPUT_LOW	}, /* WL_PCM_DI */ 
{32 * 3 +  4,	GSS_INPUT_NOPULL  }, /* PD4 ??*/
{32 * 3 +  5,	GSS_INPUT_NOPULL}, /* K_VALID */
{32 * 3 +  6,	GSS_OUTPUT_LOW}, /* PS2_KCLK */
{32 * 3 +  7,	GSS_OUTPUT_LOW}, /* PS2_KDATA */
{32 * 3 +  8,	GSS_INPUT_PULL}, /* NC */
{32 * 3 +  9,	GSS_INPUT_PULL}, /* NC */
{32 * 3 + 10,	GSS_INPUT_NOPULL}, /* IR_DATA */
{32 * 3 + 11,	GSS_OUTPUT_LOW  }, /* MOTOR */
{32 * 3 + 12,	GSS_OUTPUT_LOW	}, /* HDMI_I2S_BLK */
{32 * 3 + 13,	GSS_OUTPUT_LOW	}, /* HDMI_I2S_WS  */
{32 * 3 + 14,	GSS_OUTPUT_LOW  }, /* CLK32 */ 
{32 * 3 + 15,	GSS_INPUT_PULL  }, /* NC */ 
{32 * 3 + 16,	GSS_INPUT_NOPULL}, /* ???? */ 
{32 * 3 + 17,	GSS_INPUT_NOPULL}, /* BOOT_SEL0 */
...
{32 * 3 + 24,	GSS_OUTPUT_LOW}, /* WL_MSC1_CLK */
{32 * 3 + 25,	GSS_OUTPUT_LOW}, /* WL_MSC1_CMD */
...
{32 * 4 + 10,	GSS_OUTPUT_LOW	}, /* OTG_DRVVBUS */ 
{32 * 4 + 11,	GSS_OUTPUT_LOW}, /* LCD_RESET_EN */ 
{32 * 4 + 12,	GSS_OUTPUT_LOW}, /* TP_DRV_EN */ 
{32 * 4 + 13,	GSS_INPUT_PULL}, /* NC */ 
{32 * 4 + 14,	GSS_INPUT_NOPULL}, /* USB_ID/OTG_ID */ 
{32 * 4 + 15,	GSS_INPUT_PULL}, /* NC */ 
{32 * 4 + 16,	GSS_INPUT_PULL}, /* NC */ 
{32 * 4 + 17,	GSS_INPUT_PULL	}, /* HDMI_PWR_EN NC*/ 
{32 * 4 + 18,	GSS_OUTPUT_LOW}, /* WL_RST_N */ 
...
{32 * 4 + 24,	GSS_INPUT_PULL}, /* NC */ 
{32 * 4 + 25,	GSS_INPUT_NOPULL}, /* PA25/SDATA */ 
{32 * 4 + 26,	GSS_INPUT_PULL}, /* NC */ 
{32 * 4 + 27,	GSS_INPUT_PULL}, /* NC */ 
{32 * 4 + 28,	GSS_INPUT_NOPULL}, /* PE28/SCLK*/ 
{32 * 4 + 29,	GSS_INPUT_NOPULL}, /* PE29/VOL+ */ 
...
{32 * 5 +  5,	GSS_INPUT_NOPULL}, /* DC_DETE */ 
...
{32 * 5 + 19,	GSS_INPUT_NOPULL	}, /* HP_MUTE */ 
