...
static const struct {
	...
	{CPHYSADDR(BCH_BHDR), DMA_8BIT_TX_CMD | DMA_MODE_WRITE, DMAC_DRSR_RS_BCH_ENC},
	{CPHYSADDR(BCH_BHDR), DMA_8BIT_TX_CMD | DMA_MODE_WRITE, DMAC_DRSR_RS_BCH_DEC},
#endif
...
//	{CPHYSADDR(TSSI_FIFO), DMA_32BIT_RX_CMD | DMA_MODE_READ, DMAC_DRSR_RS_TSSIIN},
	...
	{CPHYSADDR(PCM_PDP(PCM0)), DMA_16BIT_TX_CMD | DMA_MODE_WRITE, DMAC_DRSR_RS_PMOUT},
	{CPHYSADDR(PCM_PDP(PCM0)), DMA_16BIT_RX_CMD | DMA_MODE_READ, DMAC_DRSR_RS_PMIN},
//	{CPHYSADDR(PCM_PDP(PCM1)), DMA_16BIT_TX_CMD | DMA_MODE_WRITE, DMAC_DRSR_RS_PMOUT},
//	{CPHYSADDR(PCM_PDP(PCM1)), DMA_16BIT_RX_CMD | DMA_MODE_READ, DMAC_DRSR_RS_PMIN},
	{CPHYSADDR(MSC_TXFIFO(2)), DMA_32BIT_TX_CMD | DMA_MODE_WRITE, DMAC_DRSR_RS_MSC2OUT},
	{CPHYSADDR(MSC_RXFIFO(2)), DMA_32BIT_RX_CMD | DMA_MODE_READ, DMAC_DRSR_RS_MSC2IN},
	{},
};
